...
export const DEMO_LOCATIONS: Location[] = [
  {
    ...
    active: true,
    opening_hours: {
      mon: { open: true, ranges: [{ from: "08:00", to: "00:00" }] },
      tue: { open: true, ranges: [{ from: "08:00", to: "00:00" }] },
      wed: { open: true, ranges: [{ from: "08:00", to: "00:00" }] },
      thu: { open: true, ranges: [{ from: "08:00", to: "00:00" }] },
      fri: { open: true, ranges: [{ from: "08:00", to: "02:00" }] },
      sat: { open: true, ranges: [{ from: "10:00", to: "02:00" }] },
  ...
  },
  {
    ...
    opening_hours: {
      ...
      tue: { open: true, ranges: [{ from: "12:00", to: "16:00" }, { from: "19:00", to: "00:00" }] },
      wed: { open: true, ranges: [{ from: "12:00", to: "16:00" }, { from: "19:00", to: "00:00" }] },
      thu: { open: true, ranges: [{ from: "12:00", to: "16:00" }, { from: "19:00", to: "00:00" }] },
      fri: { open: true, ranges: [{ from: "12:00", to: "16:00" }, { from: "19:00", to: "02:00" }] },
      sat: { open: true, ranges: [{ from: "12:00", to: "16:00" }, { from: "19:00", to: "02:00" }] },
      sun: { open: true, ranges: [{ from: "12:00", to: "23:00" }] },
    },
    created_at: "2025-01-01T00:00:00Z",
    updated_at: "2025-01-01T00:00:00Z",
  },
