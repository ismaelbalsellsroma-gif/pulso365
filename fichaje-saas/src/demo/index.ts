...
export const DEMO_LOCATIONS: Location[] = [
  {
    ...
    active: true,
    opening_hours: {
      mon: { open: true, from: "08:00", to: "00:00" },
      tue: { open: true, from: "08:00", to: "00:00" },
      wed: { open: true, from: "08:00", to: "00:00" },
      thu: { open: true, from: "08:00", to: "00:00" },
      fri: { open: true, from: "08:00", to: "02:00" },
      sat: { open: true, from: "10:00", to: "02:00" },
  ...
  },
  {
    ...
    active: true,
    opening_hours: {
      mon: { open: false, from: "00:00", to: "00:00" },
      tue: { open: true, from: "12:00", to: "00:00" },
      wed: { open: true, from: "12:00", to: "00:00" },
      thu: { open: true, from: "12:00", to: "00:00" },
      fri: { open: true, from: "12:00", to: "02:00" },
      sat: { open: true, from: "12:00", to: "02:00" },
      sun: { open: true, from: "12:00", to: "23:00" },
    },
    created_at: "2025-01-01T00:00:00Z",
    updated_at: "2025-01-01T00:00:00Z",
  },
